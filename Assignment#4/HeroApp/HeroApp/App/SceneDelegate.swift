...
//  HeroApp
//
//  Created by Kemel Merey on 24.03.2025.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
            ...
            let listViewModel = HeroListViewModel(service: service, router: router)

            // Wrap SwiftUI in UIHostingController
            let listView = HeroListView(viewModel: listViewModel)
